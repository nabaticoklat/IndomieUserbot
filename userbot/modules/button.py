...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}button test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/IndomieProject:same> [Support]<buttonurl:https://t.me/IndomieStore>`\
    "
    }
)
