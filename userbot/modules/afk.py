        ...
        try:
            if pic.endswith((".tgs", ".webp")):
                ...
                shites = await event.client.send_message(
                    event.chat_id,
                    f"**[{aku.first_name}](tg://user?id={aku.id}) Kembali Online Untuk Parming**\n**Dari AFK :** `{total_afk_time}` **Yang Lalu**",
                )
            else:
                shite = await event.client.send_message(
                    event.chat_id,
                    f"**[{aku.first_name}](tg://user?id={aku.id}) Pengangguran sok sibuk balik lagi!**\n**Dari AFK :** `{total_afk_time}` **Yang Lalu**",
                    file=pic,
                )
        except BaseException:
            shite = await event.client.send_message(
                event.chat_id,
                f"**[{aku.first_name}](tg://user?id={aku.id}) Kembali Online**\n**Dari AFK :** `{total_afk_time}` **Yang Lalu**",
            )
        ...
        if reason:
            try:
                if pic.endswith((".tgs", ".webp")):
                    ...
                    await event.client.send_message(
                        event.chat_id,
                        f"\n**✘ [{aku.first_name}](tg://user?id={aku.id}) Telah AFK ✘**\n**✦҈͜͡➳ Karena :** `{reason}`",
                    )
                else:
                    await event.client.send_message(
                        event.chat_id,
            ...
            try:
                if pic.endswith((".tgs", ".webp")):
                    await event.client.send_message(event.chat_id, file=pic)
                    await event.client.send_message(
                        event.chat_id, f"**✘ [{aku.first_name}](tg://user?id={aku.id}) Telah AFK ✘**"
                    )
                else:
                    await event.client.send_message(
                        event.chat_id,
                        f"**✘ [{aku.first_name}](tg://user?id={aku.id}) Telah AFK ✘**",
                        file=pic,
                    )
            except BaseException:
                await event.client.send_message(
        ...
        try:
            if reason and pic:
                if pic.endswith((".tgs", ".webp")):
                    ...
                    await event.client.send_message(
                        BOTLOG_CHATID,
                        f"\n**✘ [{aku.first_name}](tg://user?id={aku.id}) Sedang AFK ✘**\n**✦҈͜͡➳ Karena :** `{reason}`",
                    )
                else:
                    await event.client.send_message(
                        BOTLOG_CHATID,
